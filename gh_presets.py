...
SETTING_SPECS = {
    ...
    "cross_slider": SettingSpec("cross", int, C.DEFAULT_CROSS, C.CROSS_MIN, C.CROSS_MAX),
    "bridge_radio": SettingSpec("bridge", int, C.DEFAULT_BRIDGE, 0, 1),
    "seed_input": SettingSpec("seed", int, C.DEFAULT_SEED, 0, C.SEED_MAX),
}
PRESET_KEYS = {"net": "net_select", "n": "n_slider", "k": "k_slider", "regions": "regions_slider", "cross": "cross_slider", "bridge": "bridge_radio", "algorithm": "algorithm_radio", "seed": "seed_input"}
...
KEPT = {key: f"_kept_{key}" for key in ("n_slider", "k_slider", "regions_slider", "cross_slider", "bridge_radio", "seed_input")}
STEPS = {"cross_slider": 10}
